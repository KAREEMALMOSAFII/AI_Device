...
public class Device {
    ...
    public void setClockSpeed(float clockSpeed) { this.clockSpeed = clockSpeed; }
    ...
    public float getMDep() { return mDep; }
    public void setMDep(float mDep) { this.mDep = mDep; }
    ...
    public float getScH() { return scH; }
    public void setScH(float scH) { this.scH = scH; }

    public float getScW() { return scW; }
    public void setScW(float scW) { this.scW = scW; }
